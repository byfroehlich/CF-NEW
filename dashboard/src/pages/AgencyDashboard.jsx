    ...
    <div className="bg-gradient-to-r from-violet-950 to-fuchsia-950 text-white px-6 pb-4 sticky top-0 z-10" style={{ paddingTop: 'max(env(safe-area-inset-top), 1rem)' }}>
      <div className="flex items-center justify-between max-w-6xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-semibold text-white/60 uppercase tracking-wider">Agentur</span>
        </div>
    ...
    <div className={`bg-white rounded-xl border p-4 space-y-3 ${needsActivation ? 'border-blue-200' : 'border-gray-200'}`}>
      ...
      {expanded && !editing && (
        <div className="border-t border-gray-100 pt-3 space-y-3">
          ...
          <PhotoUploadSection label="Ausweisdokumente" photos={idPhotos} type="id_document" max={2} creatorId={c.id} onUploaded={refetchPhotos} />
